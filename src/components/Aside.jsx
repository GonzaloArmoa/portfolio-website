      ...
      <div className="mt-20 mx-5 md:mt-36 lg:mt-52 border-double border-4 border-gray-600 rounded-lg bg-orange-50">
        ...
        <div>
          ...
          <div className="mx-6">
            ...
            <div className="flex items-center font-semibold d mb-4"><FaGithub className="text-black text-2xl" /><a className="ml-2 text-sm underline" href="https://github.com/GonzaloArmoa?tab=repositories" target="_BLANK">/GonzaloArmoa</a></div>
            <div className="flex items-center font-bold d mb-4 justify-center "><FaCloudDownloadAlt className="text-2xl text-red-900"/><a className="ml-2 text-sm underline" href="https://drive.google.com/file/d/1mir58dZ_FrmFxgQ1mqleaPA6EfVD86Ah/view?usp=drive_link">Descargar CV</a></div>
          </div>
